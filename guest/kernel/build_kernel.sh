...
# the CI build published with each release is the canonical artifact (README "Publishing");
# the .sha256 + archived .config beside each build are the record of what was built.
make -C "$SRC" -j"$(nproc)" \
